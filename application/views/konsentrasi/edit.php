...
<table class="table table-bordered">
    ...
    <td width="150">Nama Kelas</td><td>
        <?php echo editcombo('kelas', 'akademik_kelas', 'col-sm-3', 'nama_kelas', 'kelas_id', '', '',$r['kelas_id']);?>
    </td>
    </tr>
    <tr>
    <td width="150">Nama Konsentrasi</td><td>
        <?php echo inputan('text', 'nama','col-sm-5','Nama Kelas ..', 1, $r['nama_konsentrasi'],'');?>
    </td>
    </tr>
    <tr>
    ...
    <td width="150">Jenjang  / Semester</td><td>
        ...
        <div class='col-sm-2'>
        <?php echo form_dropdown('semester',$semester,$r['jml_semester'],$class);?>
        </div>
    </td>
    </tr>
    ...
    <td width="150">Gelar</td><td>
        <?php echo inputan('text', 'gelar','col-sm-2','Gelar ..', 0, $r['gelar'],'');?>
    </td>
    </tr>
    <tr>
    <td width="150">Kode No</td><td>
        <?php echo inputan('text', 'kode','col-sm-3','Kode Nomor ..', 0, $r['kode_nomor'],'');?>
    </td>
    </tr>
    <tr>
         <td></td><td colspan="2"> 
