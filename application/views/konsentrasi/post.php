...
<table class="table table-bordered">
    ...
    <td width="150">Nama Kelas</td><td>
        <?php echo buatcombo('kelas', 'akademik_kelas', 'col-sm-3', 'nama_kelas', 'kelas_id', '', '');?>
    </td>
    </tr>
    <tr>
    <td width="150">Nama Konsentrasi</td><td>
        <?php echo inputan('text', 'nama','col-sm-5','Nama Kelas ..', 1, '','');?>
    </td>
    </tr>
    <tr>
    <td width="150">Wali</td><td>
        <?php echo inputan('text', 'ketua','col-sm-4','Wali ..', 0, '','');?>
    </td>
    </tr>
