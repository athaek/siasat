...
$(document).ready(function(){
 ...
 function loaddata()
 {
     ...
     $.ajax({
        url:"<?php echo base_url();?>setupbiayasekolah/loaddata",
...
<div class="col-sm-3">
    <table class="table table-bordered">
        ...
        <tr><td>Tahun Akademik
         ...
         <tr><td><?php echo anchor('setupbiayasekolah/post','Setup',array('class'=>'btn btn-primary'))?> <?php //echo anchor('','Cetak',array('class'=>'btn btn-primary'))?></td></tr>
    </table>
</div>
