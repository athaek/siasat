...
$(document).ready(function(){
 ...
 function simpan(id)
 {
     ...
     $.ajax({
        url:"<?php echo base_url();?>setupbiayasekolah/simpan",
 ...
 function loaddata()
 {
     ...
     $.ajax({
        url:"<?php echo base_url();?>setupbiayasekolah/loadform",
...
<div class="col-sm-3">
    <table class="table table-bordered">
        ...
        <tr><td><?php echo anchor('setupbiayasekolah','Kembali',array('class'=>'btn btn-primary'))?></td></tr>
    </table>
</div>
