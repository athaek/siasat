...
<div class="col-sm-3">
    ...
    <tr><td>Program Studi <?php echo buatcombo('kelas', 'akademik_kelas', '', 'nama_kelas', 'kelas_id', '', array('id'=>'kelas'))?></td></tr>
    <tr><td>Konsentrasi <?php echo combodumy('konsentrasi', 'konsentrasi')?></td></tr>
    
    <tr><td><?php echo anchor('jadwalsekolah','<span class="glyphicon glyphicon-plus"></span> Kembali',array('class'=>'btn btn-primary  btn-sm'));?> 
        </td></tr>
</table>
</div>
...
<div class="col-sm-9">
    <table class="table table-bordered" id="makul">
        <tr><td width="150">Matapelajaran</td><td>
                 <div class="col-md-6">
        ...
        <tr><td>Hari, Jam</td><td>
                ...
                <?php echo buatcombo('jam','akademik_waktu_sekolah','col-sm-4','keterangan','id_waktu','',''); ?>
            </td></tr>
        <tr><td>Ruangan</td><td>
