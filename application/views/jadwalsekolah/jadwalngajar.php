...
<div class="col-md-14">
    <table class="table table-bordered">
        <tr><th width="150">Nama Guru</th><th> : <?php echo getField('app_guru', 'nama_lengkap', 'guru_id', $guru)?></th></tr>
    ...
    <table class="table table-bordered">
        ...
        <tr><th>No</th><th>Jurusan</th><th>Kode</th><th>Matapelajaran</th><th>Hari</th><th>Ruangan</th><th>Jam</th><th>SKS</th></tr>
        <?php
        $no=1;
        foreach ($jadwal as $j)
        {
