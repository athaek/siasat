<?php
echo form_open($this->uri->segment(1).'/profilesekolah');
...
<table class="table table-bordered">
    ...
    <td width="150">Nama Sekolah</td><td>
        <?php echo inputan('text', 'nama','col-sm-4','Nama Lengkap ..', 1, $r['nama_sekolah'],'');?>
    </td>
    </tr>
 
            <tr>
    <td width="150">Alamat</td><td>
        <?php echo textarea('alamat', '', 'col-sm-5', 2, $r['alamat_sekolah']);?>
    </td>
    </tr>
      <tr>
