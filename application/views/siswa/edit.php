...
<table class="table table-bordered">
    ...
    <tr><td width="150">NPM /NAMA</td><td WIDTH="450"> 
        <?php echo inputan('text', 'nis','col-sm-4','Nis ..', 1, $r['nis'],'');?>
    ...
    <tr>
    <td width="050">Kelas / Konsentrasi</td><td>
        <div class="col-sm-6">
            <?php
            $kelas=  getField('akademik_konsentrasi', 'kelas_id', 'konsentrasi_id', $r['konsentrasi_id'])
            ?>
        <?php echo buatcombo('kelas', 'akademik_kelas', '', 'nama_kelas', 'kelas_id', $param, array('id'=>'kelas'))?>
        </div>
            <div class="col-sm-6">
         <?php echo editcombo('konsentrasi', 'akademik_konsentrasi', '', 'nama_konsentrasi', 'konsentrasi_id', array('kelas_id'=>$kelas), array('id'=>'konsentrasi'),$r['konsentrasi_id'])?>
            </div>
    </td>
    ...
    <tr class="success"><th colspan="2">Data Sekolah Asal</th><th colspan="2">Data Perguruan Tinggi Asal ( Khusus Siswa Pindahan)</th></tr>
    <tr>
